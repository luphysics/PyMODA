...
2. Installing the ecurve Package

A. Change to the directory that contains the file setup.py and the subdirectory ecurve. 
...
3. Using the ecurve Package

The ecurve package is on your Python path. To import it into a Python script or session, 
execute:
