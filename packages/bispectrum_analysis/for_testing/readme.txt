bispectrum_analysis MATLAB Python Package
...
2. Installing the bispectrum_analysis Package

A. Change to the directory that contains the file setup.py and the subdirectory 
bispectrum_analysis. If you do not have write permissions, copy all its contents to a 
...
3. Using the bispectrum_analysis Package

The bispectrum_analysis package is on your Python path. To import it into a Python script 
or session, execute:

    import bispectrum_analysis
