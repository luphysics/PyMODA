...
2. Installing the WT Package

A. Change to the directory that contains the file setup.py and the subdirectory WT. If 
...
3. Using the WT Package

The WT package is on your Python path. To import it into a Python script or session, 
execute:
