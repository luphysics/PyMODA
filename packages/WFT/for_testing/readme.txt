...
2. Installing the WFT Package

A. Change to the directory that contains the file setup.py and the subdirectory WFT. If 
...
3. Using the WFT Package

The WFT package is on your Python path. To import it into a Python script or session, 
execute:
