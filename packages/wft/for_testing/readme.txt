windowFT MATLAB Python Package
...
2. Installing the windowFT Package

A. Change to the directory that contains the file setup.py and the subdirectory windowFT. 
...
3. Using the windowFT Package

The windowFT package is on your Python path. To import it into a Python script or 
session, execute:
