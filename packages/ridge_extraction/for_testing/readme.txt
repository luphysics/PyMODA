ridge_extraction MATLAB Python Package
...
2. Installing the ridge_extraction Package

A. Change to the directory that contains the file setup.py and the subdirectory 
ridge_extraction. If you do not have write permissions, copy all its contents to a 
...
3. Using the ridge_extraction Package

The ridge_extraction package is on your Python path. To import it into a Python script or 
session, execute:
